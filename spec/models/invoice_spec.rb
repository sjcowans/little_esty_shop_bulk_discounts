...
RSpec.describe Invoice, type: :model do
  ...
  describe "instance methods" do
    ...
    it 'can give discounted revenue' do
      @merchant1 = Merchant.create!(name: 'Hair Care')
      ...
      expect(@invoice_1.discounted_revenue).to eq(147.6)
      expect(@invoice_2.discounted_revenue).to eq(10.0)
      expect(@invoice_3.discounted_revenue).to eq(16.0)
      expect(@invoice_4.discounted_revenue).to eq(15.0)
      expect(@invoice_5.discounted_revenue).to eq(1.0)
      expect(@invoice_6.discounted_revenue).to eq(3.0)
      expect(@invoice_7.discounted_revenue).to eq(6.0)
      expect(@invoice_8.discounted_revenue).to eq(1.0)
    end
  end
end
